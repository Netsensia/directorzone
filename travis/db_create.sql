...
--
-- Dumping data for table `usertargetrole`
--

LOCK TABLES `usertargetrole` WRITE;
/*!40000 ALTER TABLE `usertargetrole` DISABLE KEYS */;
/*!40000 ALTER TABLE `usertargetrole` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `usertargetrolekeyevent`
--

LOCK TABLES `usertargetrolekeyevent` WRITE;
/*!40000 ALTER TABLE `usertargetrolekeyevent` DISABLE KEYS */;
/*!40000 ALTER TABLE `usertargetrolekeyevent` ENABLE KEYS */;
UNLOCK TABLES;
