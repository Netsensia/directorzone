...
insert  into `company`(`companyid`,`number`,`name`,`dataset`,`status`,`companydate`) values (3,'05696589','NETSENSE LIMITED','LIVE','DISSOLVED',''),(4,'08313257','NETSENSE LTD','LIVE','',''),(5,'04688460','NETSENSE SOLUTIONS LIMITED','LIVE','DISSOLVED',''),(6,'04018529','NETSENSE TECHNOLOGY LIMITED','LIVE','DISSOLVED',''),(7,'06547603','NETSENS HOLDINGS LIMITED','LIVE','',''),(8,'06236637','NETSENSIA LIMITED','LIVE','',''),(9,'08700574','NETSENS LABS LTD','LIVE','',''),(10,'08700600','NETSENS TECHNOLOGIES LTD','LIVE','',''),(11,'04858210','NET SENTINEL LTD','LIVE','DISSOLVED',''),(12,'07604435','NETSER LIMITED','LIVE','','');
...
/*Data for the table `userexperience` */
...
/*Table structure for table `usertargetrole` */

DROP TABLE IF EXISTS `usertargetrole`;

CREATE TABLE `usertargetrole` (
...
/*Data for the table `usertargetrole` */

/*Table structure for table `usertargetrolekeyevent` */

DROP TABLE IF EXISTS `usertargetrolekeyevent`;

CREATE TABLE `usertargetrolekeyevent` (
  `usertargetroleid` int(11) NOT NULL,
  `keyeventid` int(11) NOT NULL,
...
/*Data for the table `usertargetrolekeyevent` */
